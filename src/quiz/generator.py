	...
	def generate(self, text) -> QuizOutput:
		...
		for chunk in self.chunk_text(text):			# go through the source text per chunks
			...
			system_prompt = (
				...
				"IMPORTANT: Always respond in the exact same language as the source material provided. Detect the language and use it throughout your response."
			...
			user_prompt = (
				...
				"LANGUAGE REQUIREMENT: All questions, answers, options, and keywords MUST be in the same language as the source material above.\n"
				"Use only facts from the source. Keep questions clear and non-overlapping. "
				"Ignore page numbers, headers/footers, boilerplate disclaimers, tables of contents, and formatting artifacts and sources (e.g., 'Page 1/10', timestamps, URLs, references, hyphenated line breaks). "
				...
				"Don't put the answer of the question in the question itself. "
